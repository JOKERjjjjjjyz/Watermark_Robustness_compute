...
def p_computation_table(k, pp_previous):
    ...
    # 并行执行 a 的计算
    Parallel(n_jobs=eta * 2)(delayed(compute_pp)(a, eta, k, sub_HYPER, sub_F, pp_previous, sub_F1) for a in range(2 * eta + 1))
